...
// ─── CONSTANTS ───
const CATEGORY_TABS = ['All', 'Dispensing', 'CD', 'Governance', 'H&S']
...
const DUMMY_SOPS = [
  { id: 1, code: 'SOP-001', title: 'Dispensing Workflow', category: 'Dispensing', version: '3.2', reviewDate: '2026-09-15', status: 'Current', acked: 11 },
  { id: 2, code: 'SOP-002', title: 'CD Receipt & Storage', category: 'CD', version: '2.1', reviewDate: '2026-04-01', status: 'Due Review', acked: 8 },
  { id: 3, code: 'SOP-003', title: 'Patient Group Directions', category: 'Dispensing', version: '1.4', reviewDate: '2026-11-20', status: 'Current', acked: 13 },
  { id: 4, code: 'SOP-004', title: 'Risk Assessment & Reporting', category: 'Governance', version: '2.0', reviewDate: '2026-02-28', status: 'Overdue', acked: 5 },
  { id: 5, code: 'SOP-005', title: 'Fire Safety Procedures', category: 'H&S', version: '1.8', reviewDate: '2026-08-10', status: 'Current', acked: 10 },
  { id: 6, code: 'SOP-006', title: 'CD Destruction Protocol', category: 'CD', version: '1.3', reviewDate: '2026-06-30', status: 'Current', acked: 9 },
  { id: 7, code: 'SOP-007', title: 'Data Protection & GDPR', category: 'Governance', version: '3.0', reviewDate: '2026-12-01', status: 'Current', acked: 12 },
  { id: 8, code: 'SOP-008', title: 'COSHH & Hazardous Substances', category: 'H&S', version: '2.5', reviewDate: '2026-03-15', status: 'Due Review', acked: 7 },
]

const STAT_CARDS = [
  { label: 'Total SOPs', value: '24', icon: 'book', color: 'emerald' },
  { label: 'Acknowledged', value: '18', icon: 'check', color: 'blue' },
  { label: 'Overdue Review', value: '3', icon: 'alert', color: 'amber' },
  { label: 'Coverage', value: '87%', icon: 'chart', color: 'emerald' },
]
...
export default function SOPLibrary() {
  ...
  // Filter SOPs
  const filtered = DUMMY_SOPS.filter(sop => {
          ...
          filtered.map(sop => (
            <div key={sop.id} className="bg-ec-card border border-ec-border rounded-xl p-4 relative overflow-hidden group hover:shadow-md transition-shadow">
              ...
              <div className="flex gap-2">
                <button
                  onClick={() => showToast('SOP viewer coming soon!', 'info')}
