export default function ClassificationBanner({ alerts, onFilterClass1 }) {
  ...
  return (
    <button
      ...
      className="w-full flex items-center gap-3 p-3 rounded-xl border border-red-400/30 bg-red-500/10 mb-4 cursor-pointer transition hover:bg-red-500/15 text-left"
      style={{ border: 'none' }}
    >
